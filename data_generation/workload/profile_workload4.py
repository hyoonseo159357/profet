...
logs = f'/home/kmubigdatagcp/profet/data_generation/logs4/{job_name}'
...
class BatchTimeCallback(tf.keras.callbacks.Callback):
    ...
    def on_train_end(self, logs=None):
        time_filename = f'/home/kmubigdatagcp/profet/data_generation/tensorstats4/times-{job_name}.pickle'
